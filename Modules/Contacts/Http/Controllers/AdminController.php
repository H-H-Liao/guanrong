...
use TypiCMS\Modules\Contacts\Http\Requests\BackendFormRequest;
...
class AdminController extends BaseAdminController
{
    ...
    public function store(BackendFormRequest $request): RedirectResponse
    {
    ...
    public function update(Contact $contact, BackendFormRequest $request): RedirectResponse
    {
