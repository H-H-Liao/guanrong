...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'memberAuth' => \App\Http\Middleware\MemberMiddleware::class,
        'memberAuthTerm' => \App\Http\Middleware\MemberTermMiddleware::class,
        'unmemberAuth' => \App\Http\Middleware\UnmemberMiddleware::class
    ];
}
