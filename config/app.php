...
return [
    ...
    */
    ...
    'providers' => [
        ...
        TypiCMS\Modules\Socialbuttons\Providers\ModuleServiceProvider::class,
        TypiCMS\Modules\Portfolios\Providers\ModuleServiceProvider::class,
        TypiCMS\Modules\Parners\Providers\ModuleServiceProvider::class,
        TypiCMS\Modules\Services\Providers\ModuleServiceProvider::class,
        TypiCMS\Modules\Newsitems\Providers\ModuleServiceProvider::class,

        /*
         * TypiCMS Core Service Provider...
         */
        TypiCMS\Modules\Homeprojects\Providers\ModuleServiceProvider::class,
        TypiCMS\Modules\Mainservices\Providers\ModuleServiceProvider::class,
        TypiCMS\Modules\Fqs\Providers\ModuleServiceProvider::class,
        TypiCMS\Modules\Contacts\Providers\ModuleServiceProvider::class,
        TypiCMS\Modules\Banners\Providers\ModuleServiceProvider::class,
        TypiCMS\Modules\Pagebanners\Providers\ModuleServiceProvider::class,
