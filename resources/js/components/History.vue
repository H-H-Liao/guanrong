            ...
            <table class="history-table table table-main mb-0">
                ...
                <tbody>
                    <tr v-for="model in filteredItems">
                        ...
                        <td>
                            <a v-if="model.href && model.title" :href="model.href + '?locale=' + model.locale">{{ model.title }}</a>
                            <a v-else-if="model.href" :href="model.href + '?locale=' + model.locale">{{ model.historable.title}}</a>
