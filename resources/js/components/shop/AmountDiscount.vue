            ...
            <el-collapse-item title="第三步驟:活動日期" name="3">
             ...
             <el-collapse-item title="第四步驟:商品選擇" name="4">
                ...
                <el-form-item label="規格選擇">
                 ...
                 <el-form-item label="促銷價格">
                      <el-input v-model="promotion_price" type="number" placeholder="促銷價格"></el-input>
                </el-form-item>
                <el-form-item>
            ...
            <el-collapse-item title="第五步驟:折扣條件" name="5">
                <el-form :inline="true"  class="demo-form-inline">
                    <el-form-item label="最小數量">
                        <el-input v-model="range.min" type="number" placeholder=""></el-input>
                    </el-form-item>
                    <el-form-item label="最大數量">
                        <el-input v-model="range.max" type="number" placeholder=""></el-input>
                    </el-form-item>
                </el-form>
            </el-collapse-item>
...
export default {
    ...
    methods:{
        ...
        addRow:function(){
            if( this.add_product_spec == null || this.add_product == null ){
                alert('請選擇所有選項');
            }else{
        ...
        getSettingJSON:function(){
            return JSON.stringify({ 'product_list':this.select_product,'range':this.range})
        },
    }
}
</script>
